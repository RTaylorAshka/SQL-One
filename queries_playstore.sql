...
SELECT genres, COUNT(genres) FROM analytics GROUP BY genres;
...
SELECT app_name, reviews, min_installs, (min_installs/reviews) AS ratio FROM analytics ORDER BY ratio desc LIMIT 1;
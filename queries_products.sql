...
INSERT INTO products (name, price, can_be_returned) VALUES ('mug', '5.00', 'false');
...
UPDATE products SET price = (price - 20) WHERE price > 20; -- mug was giving me an error, hence the WHERE
